...
class Usuario
{
    ...
    public function crearUsuario()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO usuarios (nombre, apellido, mail, clave, puesto, estado, idPuesto, idEstado) VALUES (:nombre, :apellido, :mail, :clave, :puesto, :estado, :idPuesto, :idEstado)");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT idUser, nombre, apellido, mail, clave, puesto, estado, idPuesto, idEstado FROM usuarios");
        $consulta->execute();
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT idUser, nombre, apellido, mail, clave, puesto, estado, idPuesto, idEstado FROM usuarios WHERE idUser = :idUser");
    ...
    public function modificarUsuario($idUser)
    {
        ...
        $consulta = $objAccesoDato->prepararConsulta("UPDATE usuarios SET nombre = :nombre, apellido = :apellido, mail = :mail, clave = :clave, puesto = :puesto, estado = :estado, idPuesto = :idPuesto, idEstado = :idEstado WHERE idUser = :idUser");
        $claveHash = password_hash($this->clave, PASSWORD_DEFAULT);
        $consulta->bindValue(':idUser', $idUser, PDO::PARAM_INT);
        $consulta->bindValue(':nombre', $this->nombre, PDO::PARAM_STR);
        $consulta->bindValue(':apellido', $this->apellido, PDO::PARAM_STR);
